package me.izhong.dashboard.manage.cache;
...
public class RedisCache<K, V> implements Cache<K, V> {
    ...
    private String getRedisKeyFromPrincipalIdField(PrincipalCollection key) {
        ...
        if (pincipalIdGetter == null) {
            throw new RuntimeException(principalObject.getClass() +  this.principalIdFieldName);
        }
        ...
        try {
            ...
            throw new RuntimeException(principalObject.getClass() + this.principalIdFieldName, e);
