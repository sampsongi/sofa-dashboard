...
public class IpUtil {
    ...
    public static String getRealAddressByIP(String ip) {
        ...
        if (Global.isAddressEnabled()) {
            if(Global.isUseLocalIpDatabase()) {
                try {
                    IPLocation ipl = new IPLocation(Global.getIpFilePath());
                    Location lo = ipl.fetchIPLocation(ip);
                    if(lo != null) {
    ...
    public static void main(String[] args) throws Exception {
        IPLocation ipl = new IPLocation("/Users/jimmy/space/tianru/zdashboard/dashboard-common/src/main/resources/data/qqwry.dat");
        Location lo = ipl.fetchIPLocation("116.237.25.170");
        if(lo != null) {
